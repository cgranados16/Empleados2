...
namespace EmpleadosUWP.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<EmployeesGridPage>("Shell_EmployeesGrid".GetLocalized(), Symbol.People));
            _primaryItems.Add(ShellNavigationItem.FromType<EmployeeDetailsPage>("Shell_EmployeeDetails".GetLocalized(), Symbol.Document));
        }
